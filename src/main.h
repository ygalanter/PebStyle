...
#define KEY_TIMEZONE_NAME 11
  ...
  #define SECONDARY_INFO_CURRENT_LOCATION_STREET_LEVEL 2
  #define SECONDARY_INFO_CURRENT_LOCATION_TOWN_LEVEL 6
  #define SECONDARY_INFO_CURRENT_LOCATION_COUNTRY_LEVEL 7

  #define SECONDARY_INFO_CURRENT_MILITARY_TIME 4
  #define SECONDARY_INFO_HEALTH_STEP_COUNTER 5
